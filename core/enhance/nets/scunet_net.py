# -*- coding: utf-8 -*-
"""
SCUNet 网络结构(vendored)/ SCUNet architecture, vendored.

来源 / Source: https://github.com/cszn/SCUNet  models/network_scunet.py
许可证 / License: Apache-2.0 (见同目录 LICENSE-SCUNet / see LICENSE-SCUNet).
本地改动 / Local edits: 移除未使用的 `from thop import profile` 与 __main__ 自测块,
仅保留前向推理所需代码。Removed unused thop import and __main__ self-test block.
"""
# -*- coding: utf-8 -*-
import math
import torch
...
class Block(nn.Module):
    def __init__(self, input_dim, output_dim, head_dim, window_size, drop_path, type='W', input_resolution=None):
        ...
        # [vendored] 静默原始调试输出 / silenced original debug print
